...
public class MoyasarListener implements OSGIKillbillEventDispatcher.OSGIKillbillEventHandler {

    private static final Logger logger = LoggerFactory.getLogger(MoyasarListener.class);

    private final OSGIKillbillAPI osgiKillbillAPI;

    public MoyasarListener(final OSGIKillbillAPI killbillAPI) {
