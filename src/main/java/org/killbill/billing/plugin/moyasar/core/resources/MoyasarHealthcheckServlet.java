...
import org.killbill.billing.plugin.moyasar.core.MoyasarHealthcheck;
...
@Singleton
@Path("/healthcheck")
public class MoyasarHealthcheckServlet extends PluginHealthcheck {

    private final MoyasarHealthcheck healthcheck;

    @Inject
    public MoyasarHealthcheckServlet(final MoyasarHealthcheck healthcheck) {
